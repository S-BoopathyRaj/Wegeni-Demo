	...
	<div class="container">
		<div class="row">
			<div class="col-xl-10 text-center mx-auto">
				...
				<h2 class="mb-4">Crafting Tomorrow's Solutions Today</h2>
				<p class="lead mb-0">We're committed to going above and beyond to deliver results that propel your success. Let's embark on this journey together and transform your vision into reality.</p>
	...
	<div class="container">
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6 ps-xl-7">
				<h2 class="mb-4">Know About WeGeni</h2>
				<p>Established in 2017, WeGeni empowers businesses to navigate the ever-changing Tech landscape. We're a End-to-End solutions provider, offering a comprehensive suite specifically tailored to your unique needs. Our team of experts provides insightful consulting, helping you chart the best course for your Tech infrastructure. We then deliver cutting-edge solutions and reliable support across a wide range of Business , ensuring your systems run smoothly and securely. This allows your business to focus on what it does best, while WeGeni takes care of the critical Tech foundation you rely on. </p>
				<p class="mb-4">We don't stop there. We continuously invest in industry-leading tools and refine our processes to deliver exceptional Solutions consistently. This unwavering commitment to excellence ensures WeGeni remains your trusted partner as your Tech & business needs evolve, helping you achieve your full potential in today's dynamic digital world. </p>
				<!-- Button -->
				<a class="btn btn-dark me-3 mb-0" href="#">Explore services!</a>
				<a class="icon-link icon-link-hover" href="#">Request a quote<i class="bi bi-arrow-right"></i> </a>
	...
	<div class="container">
		<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4">
			...
			<div class="col">
				<div class="bg-light border text-center rounded p-4">
					<div class="d-flex justify-content-center">
						<h4 class="purecounter mb-0" data-purecounter-start="0" data-purecounter-end="20" data-purecounter-delay="300">0</h4>
			...
			<div class="col">
				<div class="bg-light border text-center rounded p-4">
					<div class="d-flex justify-content-center">
						<h4 class="purecounter mb-0" data-purecounter-start="0" data-purecounter-end="100" data-purecounter-delay="300">0</h4>
						<span class="h4 text-primary mb-0">%</span>
					</div>
					<p class="text-center heading-color mb-0">Trust</p>
				</div>
			</div>
			...
			<div class="col">
				<div class="bg-light border text-center rounded p-4">
					...
					<p class="text-center heading-color mb-0">Product Branding</p>
				</div>
			</div>
			...
			<div class="col">
				<div class="bg-light border text-center rounded p-4">
					<div class="d-flex justify-content-center">
						<h4 class="purecounter mb-0" data-purecounter-start="0" data-purecounter-end="25" data-purecounter-delay="25">0</h4>
						<span class="h4 text-primary mb-0">+</span>
					</div>
		...
		<div class="row g-4 mt-5">
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card card-body bg-transparent p-0">
					...
					<p class="mb-0">We provide a comprehensive suite of services, eliminating the need for multiple vendors and streamlining your innovation journey.</p>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card card-body bg-transparent p-0">
					...
					<p class="mb-0">Our solutions are grounded in data analysis and insights, ensuring informed decision-making at every step.</p>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card card-body bg-transparent p-0">
					...
					<h6>Future-Proof Focus</h6>
					<p class="mb-0">We consider not only your immediate needs but also how your business can adapt and scale for long-term success.</p>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-3">
				<div class="card card-body bg-transparent p-0">
					...
					<p class="mb-0">Our team of experts is dedicated to your success and brings a wealth of experience and enthusiasm to every project.</p>
				</div>
			</div>
		</div>
		<!-- Value END -->
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-3 mb-2 mb-md-0">
				<h5 class="pe-6">Across 10+ Countries</h5>
			</div>
				...
				<div class="swiper" data-swiper-options='{
					...
					<div class="swiper-wrapper align-items-center">
						...
						<div class="swiper-slide">
							<img src="../assets/images/client/1.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/2.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/3.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/4.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/5.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/6.svg" class="grayscale" alt="client-img">
						</div>
						<div class="swiper-slide">
							<img src="../assets/images/client/7.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/8.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/9.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/10.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/11.svg" class="grayscale" alt="client-img">
						</div>
						<!-- Image -->
						<div class="swiper-slide">
							<img src="../assets/images/client/12.svg" class="grayscale" alt="client-img">
						</div>
						<div class="swiper-slide">
							<img src="../assets/images/client/13.svg" class="grayscale" alt="client-img">
						</div>
						<div class="swiper-slide">
							<img src="../assets/images/client/14.svg" class="grayscale" alt="client-img">
						</div>
					</div>
				</div>
				<!-- Slider END -->
		...
		<div class="row g-4 g-lg-7">
			...
			<div class="col-md-8">
				<div class="bg-dark rounded position-relative overflow-hidden d-flex p-4 p-sm-5 m-auto h-100">
					...
					<div class="row position-relative m-auto">
						<!-- Title and inputs -->
						<div class="col-lg-8 mx-auto text-center">
							<img src="../assets/images/logo-icon.svg" class="mb-3" alt="">
							<!-- Title -->
							<h3 class="text-white mb-3">Join our community</h3>
							<p class="text-white mb-3">Join the Mizzle revolution today and be part of the millions who've already embraced a brighter future!</p>
							<a href="../career/career.php" class="btn btn-light mb-0">Apply now</a>
						</div>
					</div> <!-- Row END -->
				</div>
			</div>
			...
			<div class="col-md-4">
				...
				<div class="card overflow-hidden bg-light">
					...
					<div class="card-footer position-relative p-0">
						...
						<!-- Button -->
						<a href="#" class="btn btn-outline-white mb-0 position-absolute top-50 start-50 translate-middle z-index-1">Read story</a>
						<img src="../assets/images/stories/02.jpg" alt="">
					</div>
				</div>
			</div>
