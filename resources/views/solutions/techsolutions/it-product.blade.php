	...
	<div class="container pt-lg-4">
		<div class="row g-4 g-xxl-5">
			<div class="col-lg-7 position-relative mx-auto text-center">
                ...
                <span class="font-heading heading-color d-inline-block bg-light px-3 py-2 rounded-3 mb-4">🤩 Tech Solutions</span>
				<!-- Title -->
				<h2 class="mb-3">Gen-i's Pinnacle IT Products</h2>
				<p>Our IT products simplify your business operations and enhance your digital security, empowering you to focus on growth and innovation with peace of mind.</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6 ps-md-5">
				<h2 class="mb-4">Why Do You Need Custom IT Products for Your Business?</h2>
				<p class="mb-0">Custom IT products cater to your unique needs, optimizing efficiency and security for smoother operations.</p>
				...
				<div class="row row-cols-1 row-cols-sm-2">
					<div class="col">
						<ul class="list-group list-group-borderless mb-0">
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Customized Products</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Collaborative Development</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>User-Centric Design</li>
                            <li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Enhanced Performance</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Cutting-Edge Technology</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Personalized Solutions</li>
						</ul>
					</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<p>IT product agencies specialize in delivering innovative software solutions and hardware products to meet the diverse needs of businesses and consumers.</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
					    ...
					    <p>Effective strategy and planning are essential for the successful development and launch of IT products.</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<p>Product development is a comprehensive process. The goal is to deliver a product that aligns with customer needs and drives business growth.</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<p>A product marketing strategy defines product positioning, pricing, and promotion. It identifies target audiences and charts the product's journey from development to growth.</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<p>A robust market strategy is essential for IT product success. It involves target market identification, product positioning, and effective marketing and sales execution.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row justify-content-center g-sm-6 mt-6">
				...
				<div class="card card-body text-center bg-transparent p-0">
					...
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Software Development</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Product Design and Development</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>  IT Consulting</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Quality Assurance and Testing</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> IT Infrastructure Solutions</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Cloud Services</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Cybersecurity Solutions</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>  Data Analytics and Business Intelligence</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> IoT Solutions</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Identify target market</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Market research</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Competitive analysis</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Product positioning</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Product roadmap</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Agile development methodology</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> User-centered design</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Minimum viable product (MVP)</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Iterative development</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>Launch plan</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Pricing strategy</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Sales and distribution channels</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Marketing and promotion</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Product lifecycle management</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Customer feedback</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Product updates and enhancements</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>Metrics and analytics</li>
						</ul>
					</div>
				</div>
			</div>
