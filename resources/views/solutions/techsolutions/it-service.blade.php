	...
	<div class="container pt-lg-4">
		<div class="row g-4 g-xxl-5">
			<div class="col-lg-7 position-relative mx-auto text-center">
				...
				<!-- Title -->
				<h2 class="mb-3">Gen-i's Quantum IT Services</h2>
	...
	<div class="container">
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6 ps-md-5">
				<h2 class="mb-4">Empowering Your Business with Innovative Solutions</h2>
				<p class="mb-0">Our goal is not just to meet your expectations but to exceed them, ensuring your complete satisfaction with our solutions.</p>
				...
				<div class="row row-cols-1 row-cols-sm-2">
					<div class="col">
						<ul class="list-group list-group-borderless mb-0">
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Customized Solutions</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Continuous Collaboration</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Measurable Results</li>
                            <li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Customized Solutions</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Continuous Collaboration</li>
							<li class="list-group-item d-flex"><i class="bi bi-patch-check-fill text-primary me-2"></i>Measurable Results</li>
						</ul>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<!-- Content -->
						<h5 class="mb-3">Strategic Alignment for It Services</h5>
						<p>Strategic alignment integrates IT goals with business objectives. IT becomes a strategic partner driving growth and innovation.</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<!-- Content -->
						<h5 class="mb-3">Service Delivery and Management</h5>
					    <p>Service delivery and management focus on efficient service delivery. It ensures customer satisfaction by exceeding expectations.</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<p>Customer focus is paramount in IT services. Prioritizing customer needs, expectations, and satisfaction builds strong relationships and drives business growth.</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<!-- Content -->
						<h5 class="mb-3">Innovation and Efficiency</h5>
						<p>Innovation and efficiency are critical for IT service providers' success. These elements enhance service delivery, customer satisfaction, and competitive advantage.</p>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-hover-shadow border h-100 p-4">
					...
					<div class="card-body p-0">
						...
						<!-- Content -->
						<h5 class="mb-3">Governance and Compliance</h5>
						<p>Governance and compliance are critical for aligning IT operations with business objectives, mitigating risks, and ensuring regulatory adherence</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row justify-content-center g-sm-6 mt-6">
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<!-- Title -->
					<h6 class="mb-2">Strategic Alignment for It Services</h6>
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Business Objective Alignment</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Value Proposition</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>Service Portfolio Management</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>Service Level Agreements (SLAs)</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<!-- Title -->
					<h6 class="mb-2">Service Delivery and Management:</h6>
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Incident and Problem Management</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Change Management</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Capacity Management</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>IT Service Continuity Management</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<!-- Title -->
					<h6 class="mb-2">Customer Focus</h6>
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Customer Relationship Management (CRM)</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Customer Satisfaction Measurement</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Service Desk Operations</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>Knowledge Management</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<!-- Title -->
					<h6 class="mb-2">Innovation and Efficiency</h6>
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>IT Automation</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>Cloud Adoption</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Emerging Technologies</li>
			...
			<div class="col-sm-6 col-lg-4 mb-5 mb-sm-0">
				<div class="card card-body text-center bg-transparent p-0">
					...
					<!-- Title -->
					<h6 class="mb-2">Governance and Compliance</h6>
					<div class="mb-0 d-flex justify-content-around">
						<ul class="list-group list-group-borderless text-start">
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> IT Governance Framework</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Risk Management	</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i> Compliance Management</li>
							<li class="list-group-item heading-color"><i class="bi bi-check-lg text-primary me-1"></i>Security Management</li>
						</ul>
					</div>
				</div>
			</div>
